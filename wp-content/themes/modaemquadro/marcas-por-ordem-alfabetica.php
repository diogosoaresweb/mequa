<?php
/**
Template Name: Marcas por Ordem Alfabética */
get_header();
?>
 ...
 <div class="contentSession">
  <div class="rContainer">
   ...
   <div id="autoScroll" class="colls colls-4 subSessionBar">
	...
	<div class="coll option ordemAlfabetica active">
   ...
   <div class="registers">
	<ul class="grids grids-4 first">
	 ...
	 <li class="grid first">
	  <h3>
	   <a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">A</a>
	  </h3>
	 ...
	 <li class="grid">
	  <h3>
	   <a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">B</a>
	  </h3>
	  <ul class="gridRegisters">
	   <li class="register first"><a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">BRAND EXEMPLO</a></li>
	   <li class="register"><a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">BRAND EXEMPLO</a></li>
	 ...
	 <li class="grid">
	  <h3>
	   <a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">C</a>
	  </h3>
	  <ul class="gridRegisters">
	   <li class="register first"><a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">BRAND EXEMPLO</a></li>
	   <li class="register"><a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">BRAND EXEMPLO</a></li>
	 ...
	 <li class="grid">
	  <h3>
	   <a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">D</a>
	  </h3>
	  <ul class="gridRegisters">
	   <li class="register first"><a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">BRAND EXEMPLO</a></li>
	   <li class="register"><a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">BRAND EXEMPLO</a></li>
	 ...
	 <li class="grid">
	  <h3>
	   <a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">E</a>
	  </h3>
	  <ul class="gridRegisters">
	   <li class="register first"><a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">BRAND EXEMPLO</a></li>
	   <li class="register"><a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">BRAND EXEMPLO</a></li>
	 ...
	 <li class="grid">
	  <h3>
	   <a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">F</a>
	  </h3>
	  <ul class="gridRegisters">
	   <li class="register first"><a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">BRAND EXEMPLO</a></li>
	   <li class="register"><a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">BRAND EXEMPLO</a></li>
	 ...
	 <li class="grid">
	  <h3>
	   <a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">G</a>
	  </h3>
	  <ul class="gridRegisters">
	   <li class="register first"><a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">BRAND EXEMPLO</a></li>
	   <li class="register"><a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">BRAND EXEMPLO</a></li>
	 ...
	 <li class="grid last">
	  <h3>
	   <a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">H</a>
	  </h3>
	  <ul class="gridRegisters">
	   <li class="register first"><a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">BRAND EXEMPLO</a></li>
	   <li class="register"><a href="<?php echo get_site_url().'/marcas/a-marca/'; ?>">BRAND EXEMPLO</a></li>
